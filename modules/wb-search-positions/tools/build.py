# -*- coding: utf-8 -*-
"""Сборка центрального кода модуля «Позиции в поиске WB» со встроенными проверками.
...
PUBLIC = ["posRunAll", "posRunSelected", "posDailyTrigger", "continueQueue",
          "posInstallDailyTrigger", "posRemoveDailyTrigger", "posResetRun",
          "upgradeSheets", "posHelp", "posStatus", "posCheckConnection"]

# Внутренние функции, без которых прогон молча теряет этап
REQUIRED = ["posStart_", "posStep_", "posPhaseJam_", "posPhaseSearch_", "posFinalize_",
            "posJamChunk_", "posLocate_", "posQueueBuild_", "posHistoryWrite_", "posNotify_"]
...
def brand_words():
    ...
    path = os.environ.get("POS_LEAK_WORDS", "")
